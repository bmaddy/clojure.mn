...
cljs.core.with_meta = function with_meta(b, c) {
  ...
  return d ? with_meta.call(null, function() {
    if(void 0 === cljs.core.t3730) {
      cljs.core.t3730 = {};
      cljs.core.t3730 = function(b, c, d, e) {
        this.meta = b;
        this.o = c;
        this.with_meta = d;
        this.meta3731 = e;
      ...
      cljs.core.t3730.cljs$lang$type = !0;
      cljs.core.t3730.cljs$lang$ctorStr = "cljs.core/t3730";
      cljs.core.t3730.cljs$lang$ctorPrWriter = function(b, c) {
        return cljs.core._write.call(null, c, "cljs.core/t3730")
      };
      var d = cljs.core.t3730.prototype, f = function(b, c) {
      ...
      d.call = g;
      cljs.core.t3730.prototype.apply = function(b, c) {
        b = this;
        return b.call.apply(b, [b].concat(c.slice()))
      };
      cljs.core.t3730.prototype.cljs$core$Fn$ = !0;
      cljs.core.t3730.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta3731
      };
      cljs.core.t3730.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
        return new cljs.core.t3730(this.meta, this.o, this.with_meta, c)
      }
    }
    return new cljs.core.t3730(c, b, with_meta, null)
...
var clojuremn = {homepage:{}};
clojuremn.homepage.common_links = cljs.core.PersistentHashMap.fromArrays("Nick Bauman;Dan Callahan;Benjamin Ebby;Professor Machkasova;Andrew Luetgers;Brian Maddy;Tom Marble;Ted Naleid;Ben Peirce;Scott Fritchie;Nate Young".split(";"), "https://github.com/nickbauman/ http://dancallahan.info/ http://twitter.com/akpanydre http://personal.morris.umn.edu/~elenam/ https://twitter.com/lootsauce http://twitter.com/bmaddy http://twitter.com/tmarble https://twitter.com/tednaleid http://bpeirce.me https://twitter.com/slfritchie https://twitter.com/natesbrain".split(" "));
clojuremn.homepage.link = function() {
  var a = null, b = function(b) {
    return a.call(null, b, clojuremn.homepage.common_links.call(null, b))
  }, c = function(a, b) {
    return cljs.core.truth_(b) ? cljs.core.PersistentVector.fromArray(["\ufdd0:a", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:href", b], !0), a], !0) : a
  }, a = function(a, e) {
    switch(arguments.length) {
      case 1:
        return b.call(this, a);
...
clojuremn.homepage.html5 = function() {
  var a = function(a) {
    return[cljs.core.str("<!DOCTYPE html>"), cljs.core.str("<html>"), cljs.core.str("" + cljs.core.str(hiccups.runtime.render_html.call(null, a))), cljs.core.str("</html>")].join("")
  }, b = function(b) {
    var d = null;
    0 < arguments.length && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
clojuremn.homepage.index = function() {
  return clojuremn.homepage.html5.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0:head", cljs.core.PersistentVector.fromArray(["\ufdd0:meta", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:charset", "utf-8"], !0)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:title", "Clojure.mn - The Minnesota Clojure User Group"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:link", cljs.core.PersistentArrayMap.fromArray("\ufdd0:rel stylesheet \ufdd0:type text/css \ufdd0:href /stylesheets/base.css".split(" "), 
  !0)], !0)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:body", cljs.core.PersistentVector.fromArray(["\ufdd0:div", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:id", "content"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h1", "Clo", cljs.core.PersistentVector.fromArray(["\ufdd0:span", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:id", "clojure-j"], !0), "j"], !0), "ure.mn"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:id", 
  "tagline"], !0), "The Minnesota Clojure Users Group"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:class", "announcement"], !0), "Join our ", clojuremn.homepage.link.call(null, "mailing list", "http://groups.google.com/group/clojuremn"), ". Follow us on ", clojuremn.homepage.link.call(null, "Twitter", "http://twitter.com/clojuremn"), "."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:img", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:id", 
  "logo", "\ufdd0:src", "/images/lambda.png"], !0)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", "We meet the first Wednesday of the month at 7pm at ", clojuremn.homepage.link.call(null, "SmartThings", "http://www.smartthings.com/"), "."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p.map", clojuremn.homepage.link.call(null, "Map/directions", "https://maps.google.com/maps?q=11+4th+St+NE+%23300+Minneapolis,+MN+55413+(SmartThings)&hl=en&sll=44.988865,-93.255102&sspn=0.010638,0.02708&hnear=11+4th+St+NE+%23300,+Minneapolis,+Hennepin,+Minnesota+55413&t=m&z=16&iwloc=A")], 
  !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "Next Meeting: Wednesday, October 2nd, 2013, at 7:00pm"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "September 4th, 2013"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", "Hack Fest"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "August 7st, 2013"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Dan Callahan"), " showed us some quick tips for better website security"], 
  !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "July 3rd, 2013"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", "Hack Fest"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "June 5th, 2013"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Professor Machkasova"), " from the University of Minnesota Morris presented the work she and ", clojuremn.homepage.link.call(null, "Stephen Adams"), " have been doing to transition the university's introductory computer science class from Racket to Clojure."], 
  !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "May 1st, 2013"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Greg Allen"), " taught us about testing in Clojure, ", clojuremn.homepage.link.call(null, "Andrew Luetgers"), " showed us his ", clojuremn.homepage.link.call(null, "mr-hiccup", "https://github.com/andrewluetgers/mr-hiccup"), " project he's been working on, ", clojuremn.homepage.link.call(null, "Tom Marble"), " gave us an update on ", 
  clojuremn.homepage.link.call(null, "Nongrata", "https://github.com/tmarble/nongrata"), ", and ", clojuremn.homepage.link.call(null, "Brian Maddy"), " gave a quick preview of the schelling visualization app he's working on."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "April 3rd, 2013"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", "Hack Fest"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "March 6th, 2013"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", 
  clojuremn.homepage.link.call(null, "Erik Rantapaa"), " talked about type classes and Haskell and ", clojuremn.homepage.link.call(null, "Brian Maddy"), " gave a demo of a little ", clojuremn.homepage.link.call(null, "game he made", "http://conbat.herokuapp.com/"), " (", clojuremn.homepage.link.call(null, "source", "https://github.com/bmaddy/conbat"), ")."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "February 6th, 2013"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, 
  "Benjamin Ebby"), " showed us some of the ZeroMQ stuff he's been playing with recently and Daniel showed us the features of a ray-tracer he wrote in Clojure."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "December 5th, 2012"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Greg Allen"), " showed us a ", clojuremn.homepage.link.call(null, "distance measuring project", "https://github.com/gdallen/walk"), " he's been working on, then we had various lightening talks."], 
  !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "November 7th, 2012"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", "Hack Fest - Multiple small groups worked on all sorts of things including ", clojuremn.homepage.link.call(null, "Nongrata", "https://github.com/tmarble/nongrata"), ", ", clojuremn.homepage.link.call(null, "Light Table", "http://www.lighttable.com/"), ", ", clojuremn.homepage.link.call(null, "Clojure Koans", "http://clojurekoans.com/"), ", ", clojuremn.homepage.link.call(null, 
  "Conduit", "https://github.com/jduey/conduit"), ", ", "and discussing Erlang's QuickCheck."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "October 3, 2012"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", "Hack Fest - We went through the ", clojuremn.homepage.link.call(null, "Datomic tutorial", "http://docs.datomic.com/tutorial.html")], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "September 5, 2012"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, 
  "Nate Young"), " - using clojure at ", clojuremn.homepage.link.call(null, "Revelytix", "http://www.revelytix.com/"), cljs.core.PersistentVector.fromArray(["\ufdd0:br"], !0), clojuremn.homepage.link.call(null, "Brian Maddy"), " - ", clojuremn.homepage.link.call(null, "Tetris", "https://github.com/bmaddy/tetris"), " with an ", clojuremn.homepage.link.call(null, "FRP", "http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.93.8928"), " structure"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", 
  "August 1, 2012"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Ben Peirce"), " - ", clojuremn.homepage.link.call(null, "Immutant", "http://immutant.org/"), cljs.core.PersistentVector.fromArray(["\ufdd0:br"], !0), clojuremn.homepage.link.call(null, "Scott Fritchie"), " - Creating systems with thousands or millions of actors "], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "June 6, 2012"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", 
  clojuremn.homepage.link.call(null, "Nick Bauman"), " presented his ClojureScript work on the ", clojuremn.homepage.link.call(null, "Nongrata", "https://github.com/tmarble/nongrata"), " project.  We then held lightning talks with ", clojuremn.homepage.link.call(null, "Dan Callahan"), " discussing ", clojuremn.homepage.link.call(null, "Persona", "http://identity.mozilla.com/post/18038609895/introducing-mozilla-persona"), ", ", clojuremn.homepage.link.call(null, "Tom Marble"), " demoing his ", clojuremn.homepage.link.call(null, 
  "Raspberry Pi", "http://www.raspberrypi.org/"), " serving the Nongrata website, and ", clojuremn.homepage.link.call(null, "Brian Maddy"), " talking about ", clojuremn.homepage.link.call(null, "core.logic", "https://github.com/clojure/core.logic"), "."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "May 2, 2012"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Dan Callahan"), " talked about ", clojuremn.homepage.link.call(null, "Mozilla Persona", 
  "http://identity.mozilla.com/post/18038609895/introducing-mozilla-persona"), " and the group hacked on a ", clojuremn.homepage.link.call(null, "Noir implementation of that technology", "https://github.com/tmarble/nongrata"), "."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "April 4, 2012"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Ted Naleid"), " gave his ", clojuremn.homepage.link.call(null, "review of Clojure/West 2012", "http://tednaleid.github.com/showoff-clojurewest/#1"), 
  " and ", clojuremn.homepage.link.call(null, "Ben Peirce"), " talked about ", clojuremn.homepage.link.call(null, "some random Clojure news", "/presentations/latest-news/latest-news.html"), "."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "March 7, 2012"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Nick Bauman"), " talked about ", clojuremn.homepage.link.call(null, "redit-s-expression", "http://tinyurl.com/redis-s-expression"), " and ", 
  clojuremn.homepage.link.call(null, "Brian Maddy"), " talked about ", clojuremn.homepage.link.call(null, "Pallet", "https://docs.google.com/file/d/0B593N-xk-VfFVTJtNndQZk1UbFNRc1MzXzFxR21pZw/edit"), "."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "February 1, 2012"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Tom Marble"), " shared his experiences ", clojuremn.homepage.link.call(null, "developing a web application using Noir", "/presentations/noir-is-the-new-black.org"), 
  " and ", clojuremn.homepage.link.call(null, "Benjamin Ebby"), " talked about ", clojuremn.homepage.link.call(null, "using JRuby and Rake with Clojure", "http://outcastgeek.com/blog/build-your-polyglot-app-with-jruby-and-rake.html"), "."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "December 7, 2011"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Brian Maddy"), " and ", clojuremn.homepage.link.call(null, "Ben Peirce"), " gave a review of ", 
  clojuremn.homepage.link.call(null, "Clojure/conj 2011", "http://clojure-conj.org/"), " and ", clojuremn.homepage.link.call(null, "Dan Callahan"), " talked about ", clojuremn.homepage.link.call(null, "Go", "http://golang.org/"), "'s approach to concurrency."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "November 2, 2011"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Brian Maddy"), " talked about ", clojuremn.homepage.link.call(null, "Functional Relational Programming", 
  "https://docs.google.com/a/brianmaddy.com/presentation/pub?id=1kXvRBksA7DtDpie3JOU7vY2VH23yLFpUVFc98BYLKnk&start=false&loop=false&delayms=3000#slide=id.p"), " and ", clojuremn.homepage.link.call(null, "Ben Peirce"), " talked about some tools for command line Clojure programs."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "October 5, 2011"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Greg Allen"), " talked about Clojure's ", clojuremn.homepage.link.call(null, 
  "java interop", "https://docs.google.com/present/edit?id=0AVDE9VMKvEjHZGdrZzJwcjJfMTEyYzZ6NmJwZHE&hl=en_US"), " and ", clojuremn.homepage.link.call(null, "Ben Peirce"), " talked about the relational algebra as its used in Clojure.sets."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "September 7, 2011"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Ben Peirce"), " talked about ", clojuremn.homepage.link.call(null, "Clojure sequence implementations", 
  "http://bpeirce.me/clojure-sequence-implementations.html"), " and ", clojuremn.homepage.link.call(null, "Brian Maddy"), " talked about ", clojuremn.homepage.link.call(null, "ClojureScript", "https://docs.google.com/a/brianmaddy.com/present/view?id=dwqzvn5_14f7nm7ngk"), "."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "August 10, 2011"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", clojuremn.homepage.link.call(null, "Ben Peirce"), " walked through how he used ", clojuremn.homepage.link.call(null, 
  "Ring", "https://github.com/mmcgrana/ring"), " and ", clojuremn.homepage.link.call(null, "Hiccup", "https://github.com/weavejester/hiccup"), " to make ", clojuremn.homepage.link.call(null, "this site", "https://github.com/bpeirce/clojure.mn"), ".  ", clojuremn.homepage.link.call(null, "Brian Maddy"), " showed how he used ", clojuremn.homepage.link.call(null, "Enlive", "https://github.com/cgrand/enlive"), " for one of his sites."], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:h2", "July 13, 2011"], 
  !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", "We discussed ", clojuremn.homepage.link.call(null, "Clojure/conj 2011", "http://clojure-conj.org"), ", compared the JVM to the CLR, and surveyed the NoSQL landscape."], !0)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:p", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:class", "footer"], !0), clojuremn.homepage.link.call(null, "Fork this site!", "https://github.com/bmaddy/clojure.mn")], !0)], !0))
};
cljs.nodejs = {};
...
clojuremn.core = {};
clojuremn.core.http = cljs.nodejs.require.call(null, "http");
clojuremn.core.fs = cljs.nodejs.require.call(null, "fs");
clojuremn.core.static_server = cljs.nodejs.require.call(null, "node-static").Server;
clojuremn.core.file_server = new clojuremn.core.static_server("resources/public");
clojuremn.core.success = function(a, b) {
  return a.writeHead(200, {"Content-Type":b})
};
clojuremn.core.get_file = function(a, b, c, d) {
  clojuremn.core.success.call(null, d, a);
  return d.end(clojuremn.core.fs.readFileSync([cljs.core.str("resources/public/"), cljs.core.str(b)].join("")))
};
clojuremn.core.index = function(a, b) {
  clojuremn.core.success.call(null, b, "text/html");
  return b.end(clojuremn.homepage.index.call(null))
};
clojuremn.core.routes = cljs.core.PersistentArrayMap.fromArray(["/", clojuremn.core.index, "/images/lambda.png", cljs.core.partial.call(null, clojuremn.core.get_file, "image/png", "images/lambda.png"), "/stylesheets/base.css", cljs.core.partial.call(null, clojuremn.core.get_file, "text/css", "stylesheets/base.css")], !0);
clojuremn.core.handler = function(a, b) {
  cljs.core.println.call(null, "Request: ", a.url);
  var c = clojuremn.core.routes.call(null, a.url);
  return cljs.core.truth_(c) ? c.call(null, a, b) : clojuremn.core.file_server.serve(a, b)
};
clojuremn.core.server = function(a, b, c) {
  return clojuremn.core.http.createServer(a).listen(b, c)
};
clojuremn.core._main = function() {
  var a = function() {
    var a = clojuremn.core.http.createServer(clojuremn.core.handler), b;
    b = process.env.PORT;
    b = cljs.core.truth_(b) ? b : 1337;
    a.listen(b);
    return cljs.core.println.call(null, [cljs.core.str("Server running on port "), cljs.core.str(b)].join(""))
  }, b = function(b) {
    var d = null;
    0 < arguments.length && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
cljs.core._STAR_main_cli_fn_STAR_ = clojuremn.core._main;
cljs.nodejscli = {};
